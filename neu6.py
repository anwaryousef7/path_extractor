...
class UltimateLogAnalyzer(ctk.CTk):
    def __init__(self):
        ...
        self.title("LogMaster Pro - Error-Free Edition")
    ...
    def setup_ui(self):
        ...
        self.details_box.tag_config("ip_highlight", foreground="#F39C12", font=("Consolas", 14, "bold"))
        self.details_box.tag_config("email_highlight", foreground="#3498DB", font=("Consolas", 14, "bold"))
